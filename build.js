...
const APP_WEB_ROOT_ENV = BUILD_ARGS[3] ? BUILD_ARGS[2] : 'wgo';
console.log('\x1b[34m', `APP_WEB_ROOT_ENV: ${APP_WEB_ROOT_ENV}`);

const mainmodule = require(`./deploy`);
mainmodule.buildApi(MODULE_ENV, NODE_ENV, PORT_ENV, APP_WEB_ROOT_ENV);
