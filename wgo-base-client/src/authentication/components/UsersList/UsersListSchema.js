...
export var getAuthUserListSchema = function (transStore, leftButtons, rowButtons) {
    // id: number;
    // name: string;
    // lastName: string;
    // userName: string;
    ...
    return {
        schema: {
            ...
            isEmailConfirmed: {
                ...
                field: function (row) {
                    return row.isEmailConfirmed ? "check_box" : "check_box_outline_blank";
                },
                sortable: true,
                visible: true,
                filterable: true,
...
//# sourceMappingURL=UsersListSchema.js.map