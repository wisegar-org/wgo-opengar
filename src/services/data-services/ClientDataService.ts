...
export class ClientDataService {
  ...
  constructor() {
    ...
    this._clientRepository = connection.getRepository(ClientEntity);
  }
  ...
  remove = async (id: number): Promise<Response<ClientEntity>> => {
    ...
    try {
      const clientRemoved = await this._clientRepository.remove(
        clientResp.result
      );
