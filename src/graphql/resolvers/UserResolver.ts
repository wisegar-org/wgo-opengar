...
import { UserResponseGQL, UserListResponseGQL, UserLoginResponseGQL, UserLoginToken } from '../types/responses/UserResponsesGQL';
...
export class UserResolver {
    ...
    async addUser(@Arg("data") { name, lastName, email, userName, password, roles }: UserInputGQL): Promise<Response<UserEntity>> {
    ...
    @Mutation(() => UserResponseGQL)
    async setRoles(
        @Arg("data") { userUuid, roleIds }: UserRolesInputGQL): Promise<Response<UserEntity>> {
    ...
    @Mutation(() => UserResponseGQL)
    async updateUser(@Arg("data") { id, name, lastName, email, userName, roles }: UserInputGQL): Promise<Response<UserEntity>> {
