...
export class CollaboratorController {
  ...
  async addCollaborator(
    ...
    const proj = new CollaboratorEntity(numberId, login, node_id, type, avatar_url, url, name, location, email, bio, card_number, 0, 0, address)
  ...
  async updateOrInsertCollaborator(
    ...
    collaborator = await this.updateCollaborator(collaborator?.id || 0, login, node_id, type, avatar_url, url, name, location, email, bio, isCollaborator )
    ...
    if(!collaborator){
      collaborator = new CollaboratorEntity(numberId, login, node_id, type, avatar_url, url, name, location, email, bio)
        collaborator.isCollaborator = isCollaborator
