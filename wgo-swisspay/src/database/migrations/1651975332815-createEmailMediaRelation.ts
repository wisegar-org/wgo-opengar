...
export class createEmailMediaRelation1651975332815 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "email_media" ADD CONSTRAINT "FK_64ec84c630ee9d638ee999a0f00" FOREIGN KEY ("emailId") REFERENCES "email_history"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
  }
