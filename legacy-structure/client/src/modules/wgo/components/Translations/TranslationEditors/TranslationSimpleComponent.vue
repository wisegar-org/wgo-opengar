<template>
  <div class="q-px-none q-py-md" style="width: 100%">
    <div class="row">
      ...
      <div class="col-12">
        <QEditor :toEdit="this" propToEdir="value" :label="label" />
      </div>
    </div>
  </div>
</template>
...
export default class TranslationSimpleComponent extends Vue {
  ...
  translations: { [key: string]: string } =
    this.language && this.translation
      ...
      : {};
  value =
    this.translation.value && this.translation.key !== this.translation.value
  ...
  setValue() {
    if (this.translation && this.selectedLang && this.language) {
      ...
      if (this.value === this.translation.key) this.value = '';
