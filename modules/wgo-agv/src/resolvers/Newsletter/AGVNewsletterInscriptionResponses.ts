...
export class AGVNewsletterGetInscriptionResponse {
  @Field(() => AGVNewsletterInscriptionResponse, { nullable: true }) inscription: AGVNewsletterInscriptionResponse;
}

@ObjectType()
export class AGVNewsletterInscriptionsPageResponse {
  @Field(() => [AGVNewsletterInscriptionResponse]) inscriptions: AGVNewsletterInscriptionResponse[];
