...
export class updateEmployees1657747113758 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "email_history" ALTER COLUMN "date" SET DEFAULT '"2022-07-13T21:18:36.569Z"'`);
        await queryRunner.query(`ALTER TABLE "employees" ADD CONSTRAINT "FK_a9f13e18d0f16d9963546f5b525" FOREIGN KEY ("enterprise_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "employees" ADD CONSTRAINT "FK_66910c68073ee5ab9b47ac04941" FOREIGN KEY ("client_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
