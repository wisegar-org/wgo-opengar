...
export type AgvEventGetNextsResponse = {
  ...
  corsi?: Maybe<Array<AgvEventResponse>>;
  corso?: Maybe<AgvEventResponse>;
  eventi?: Maybe<Array<AgvEventResponse>>;
...
export type EmailFromToAppInput = {
...
export type EmailToAddressAndAppInput = {
  body: Scalars['String']['input'];
  data?: InputMaybe<Scalars['String']['input']>;
  subject: Scalars['String']['input'];
  to: Scalars['String']['input'];
...
export type HistoricResponse = {
  ...
  creatoIl: Scalars['DateTime']['output'];
  entity: Scalars['String']['output'];
  id: Scalars['Float']['output'];
  message: Scalars['String']['output'];
  modificatoIl: Scalars['DateTime']['output'];
...
export type QuerySendEmailFromToAppArgs = {
  data: EmailFromToAppInput;
};


export type QuerySendEmailToAppArgs = {
  data: EmailToAppInput;
};
